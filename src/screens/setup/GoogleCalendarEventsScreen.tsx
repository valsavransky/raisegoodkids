...
export function GoogleCalendarEventsScreen({ route, navigation }: Props) {
  ...
  const confirmImport = () => {
    ...
    // rendering — this screen stays mounted when you navigate on to Schedule
    // Review and back (native-stack doesn't unmount it), so selectedIds can
    // still hold ids picked before a prior confirm added them. Without this,
    // pressing "Add" again after going back would duplicate those events.
