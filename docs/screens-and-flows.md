...
- ~~Content library for age/grade-appropriate Expected items and Gigs needs to be scoped as its own workstream~~ **In progress:** two grade bands now exist — 3rd/4th (`content-library-grade-3-4.md`, 11 Expected items, 19 Gigs) and K-2nd (`content-library-grade-k-2.md`, 10 Expected items, 13 Gigs, deliberately no Big Job tier and more "with help" framing than 3rd/4th — a younger band isn't just an easier version of the older one). Both gated by the same two household flags (yard, car — see `ChildProfile.hasYard`/`hasCar` and `SuggestedGig.ifApplicable`). **Still needs**: 5th-6th and 7th-8th bands (this band grouping — K-2nd / 3rd-4th / 5th-6th / 7th-8th — superseded the earlier elementary/middle/high-school split once actually authoring K-2nd showed single-grade or wide multi-grade bands didn't fit how independence actually changes at this age), high school content, and real-world testing/revision with families before treating any of it as final.
