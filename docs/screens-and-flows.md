...
- **Splash/start screen needs real content** — currently just the logo; wants a few lines describing what to expect from the app before the parent starts setup.
